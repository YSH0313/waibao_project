...
class MyRequests(object):
    def __init__(self, method='GET', url=None, headers=None, params=None, data=None, json_params=None, cookies=None, timeout=15, callback=None, proxy=None, level=0, verify_ssl=None, allow_redirects=True, is_file=False, retry_count=0, is_change=False, is_encode=None, ignore_ip=False, is_websource=False, page_click=None, before_do=None, input_box=None, input_text=None, input_click=None, **meta):
        ...
        self.timeout = 120 if is_file and timeout == 15 else timeout  # 超时时间
...
class MyFormRequests(object):
    def __init__(self, method='POST', url=None, headers=None, params=None, data=None, json_params=None, cookies=None, timeout=15, callback=None, proxy=None, level=0, verify_ssl=None, allow_redirects=True, is_file=False, retry_count=0, is_change=False, is_encode=None, ignore_ip=False, **meta):
        self.method = method  # 请求类型
        self.url = url  # 目标url
        ...
        self.headers = headers  # header头
        self.cookies = cookies  # 需要添加的cookie
        self.timeout = 120 if is_file else timeout  # 超时时间
        self.callback = callback  # 回调目标函数
        self.meta = {} if not meta.get('meta') else meta.get('meta')  # 需要传递的参数（字典格式）
        self.proxy = proxy  # 需要添加的代理ip
        self.level = level  # 请求优先级
...
class MyResponse(object):
    def __init__(self, url=None, headers=None, content_type=None, data=None, cookies=None, text=None, content=None, status_code=None, request_info=None, proxy=None, level=0, retry_count=0, **meta):
